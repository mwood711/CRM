...
<a href="clientlist">
<h3><font color="white">Active Clients</font></h3>
...
<div id="cardbox2">
<div class="statistic-box">
<i class="fa fa-user-secret fa-3x" style=" color: white"></i>
<div class="counter-number pull-right">
<span class="count-number">
        <?php
        require('dbconfig.php');
...
<div id="cardbox3">
<div class="statistic-box">
<i class="fa fa-calendar" fa-8x style= "color:white"></i>
<div class="counter-number pull-right">
...
<a href="Events">
<h3><font color="white"font-size: 12px; >Upcoming Events</font></h3>
<span class="pull-right-container">
</div>
</div>
</div>
...
<div id="cardbox4">
<div class="statistic-box">
<i class="fa fa-files-o fa-3x" style=" color: white"></i>
<div class="counter-number pull-right">
<span class="count-number">
        <?php
        require('dbconfig.php');  
...
<tbody>
       <?php
        ...
        $sql = "Select  event_id, date, description FROM event WHERE date >= CAST(GETDATE() AS DATE) AND date <= CAST(DATEADD(day, +7, GETDATE()) AS DATE) " ;
        $stmt = sqlsrv_query( $conn, $sql );
        if( $stmt === false) {
        die( print_r( sqlsrv_errors(), true) );
        }
...
<div class="card-header">
<div class="card-title custom_title">
<h4>Chart Showing Percentage of Contacts Attending Event</h4>
</div>
</div>
<div class="card-body">
<div style="width:100%;">   
