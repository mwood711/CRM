   ...
   <a class="btn btn-add" href="addclient"> <i class="fa fa-plus"></i> Add Client
   </a>  
   </div>
   </div> 
   <div class="btn-group">
 ...
 <a href="#" onclick="$('#dataTableExample1').tableExport({type:'pdf',pdfFontSize:'7',escape:'false'});"> 
   ...
   <?php
         ...
         echo "<tr  onclick=\"window.location='ClientDetails?custid=".$row["c_id"]."'\">
         <td>".$row['c_id']."</td>
         <td>".$row['fname']."</td>
         <td>".$row['lname']."</td>
         <td>".$row['title']."</td>
         ...
         <td align='center'><a href=\"deleteclient.php?c_id=".$row['c_id']."\" style='color:red'>Delete |</a><a href=\"clientlist?c_id=".$row['c_id']."\" style='color:none'> Edit</a></td>
         </tr>";
         }
