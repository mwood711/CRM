...
<input type="text" class="form-control" value="<?php echo $fname ?>" name="fname" placeholder="Enter First Name" required>
</div>
<div class="form-group">
<label>Last Name</label>
<input type="text" class="form-control" value="<?php echo $lname ?>" name="lname" placeholder="Enter Last Name" required>
</div>
<div class="form-group">
<label>Title</label>
<input type="test" class="form-control" value="<?php echo $title ?>" name="title" placeholder="Enter Title" required>
</div>
<div class="form-group">
<label>Info</label>
<input type="text" class="form-control" value="<?php echo $info ?>" name="info" placeholder="Enter Additional Info" required>
</div>
<div class="form-group">
<label>Office Phone </label>
<input type="text" class="form-control" value="<?php echo $phone ?>" name="phone" placeholder="Enter Office Phone" required>
</div>
<div class="form-group">
<label>Email</label>
...
<input type="text" class="form-control" value="<?php echo $city ?>" name="city" placeholder="Enter City" required>
</div>
<div class="form-group">
<label>Enter State</label>
<input type="text" class="form-control" value="<?php echo $state ?>" name="state" placeholder="Enter State" required>
</div>
<div class="form-group">
<label>Enter Zip Code</label>
<input type="text" class="form-control" value="<?php echo $zip ?>" name="zip" placeholder="Enter Zipcode" required>
</div>
<div class="form-group">
